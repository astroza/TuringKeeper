class CheckInsController < ApplicationController
  ...
  load_and_authorize_resource :except => [:show, :index, :destroy]
  ...
  def create
    ...
    user = TuringUser.where(:identifier => identifier).first
    @check_in.turing_user_id = user.id if user != nil
    
    respond_to do |format|
      if @check_in.save and user != nil and user.password == password
  ...
  private
    ...
    def check_in_params
      params.require(:check_in).permit(:turing_user_id)
    end
end
